  ...
  return (
    <div class='items-center mx-10 mb-8 border rounded shadow-md p-6 max-w-md'>
        ...
        <div class='flex flex-row my-4 justify-center'>
            <button onClick={toggleModal} class="block w-32 mx-1 py-2.5 rounded-md bg-amber-300  text-center text-sm font-semibold text-slate-950 shadow-sm hover:bg-slate-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-950 border-solid border-2 border-slate-950" >View Details</button>
            {/* <button class="block w-32 mx-1 rounded-md bg-amber-300  text-center text-sm font-semibold text-slate-950 shadow-sm hover:bg-slate-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-950 border-solid border-2 border-slate-950">Buy Ticket</button> */}
        </div>
        {isOpen && (
